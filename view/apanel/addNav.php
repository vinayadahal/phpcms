<div class="admin_site_center">
    <form method="POST" url="<?php echo baseUrl ?>apanel/insertNav" id="addForm">
        <label for="category"><h5>Item Name:</h5></label> <input id="navName" type="text" class="form-control admin_editBox_override" name="navName" />
        ...
        <button type="button" class="admin_add_btn" id="addUpdate">
            <i class="glyphicon glyphicon-saved back_btn"></i> Add Item
        </button>
    </form>
